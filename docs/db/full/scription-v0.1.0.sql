...
(
    `node_id` varchar(130) NOT NULL COMMENT 'Stake node address',
    ...
    `next_reward_per` int(11) NOT NULL DEFAULT '0' COMMENT 'Next settlement cycle commission reward ratio',
    `next_reward_per_mod_epoch` int(11) DEFAULT '0' COMMENT '[Next settlement cycle commission reward ratio] Modify the settlement cycle',
    `have_dele_reward` decimal(65, 0) NOT NULL DEFAULT '0' COMMENT 'The node current pledge has received the delegation reward',
    `pre_dele_annualized_rate` double(64, 2) NOT NULL DEFAULT '0.00' COMMENT 'Estimated commission rate of return in the previous participation cycle',
    `dele_annualized_rate` double(64, 2) NOT NULL DEFAULT '0.00' COMMENT 'Estimated commission rate of return',
...
CREATE TABLE `bubble` (
                          `id` bigint NOT NULL AUTO_INCREMENT COMMENT 'record id',
                          `bubble_id` bigint DEFAULT NULL COMMENT 'The id of the bubble created by the main chain',
                          `status` int DEFAULT NULL COMMENT 'Status: 1-Active; 2-To be released; 3-Released',
                          `create_time` datetime DEFAULT NULL COMMENT 'Creation time',
                          `update_time` datetime DEFAULT NULL COMMENT 'update time',
                          PRIMARY KEY (`id`) USING BTREE
) COMMENT='bubble information table';

DROP TABLE IF EXISTS `inscription`;
CREATE TABLE `inscription` (
                               `id` int NOT NULL AUTO_INCREMENT,
                               `contract_address` varchar(255) DEFAULT NULL COMMENT 'contract address',
                               `inscription_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT 'inscription id',
                               `tick` varchar(100) DEFAULT NULL COMMENT 'tick',
                               `total_supply` bigint DEFAULT NULL COMMENT 'total supply',
                               `limit_per_mint` bigint DEFAULT NULL COMMENT 'limit per mint',
                               `max_per_wallet` bigint DEFAULT NULL COMMENT 'max per wallet',
                               `need_extend_value` int DEFAULT '0' COMMENT '0-no;1-yes',
                               `deploy_by` varchar(255) DEFAULT NULL COMMENT 'deploy address',
                               `deploy_time` datetime DEFAULT NULL COMMENT 'deploy time',
                               `status` int DEFAULT '1' COMMENT '1:in-progress;2:completed',
                               `minted` bigint DEFAULT '0' COMMENT 'minted number',
                               `holders` int DEFAULT '0' COMMENT 'holder number',
                               `total_tx` bigint DEFAULT '0' COMMENT 'total tx',
                               `create_time` datetime DEFAULT NULL COMMENT 'create time',
                               `update_time` datetime DEFAULT NULL COMMENT 'update time',
                               PRIMARY KEY (`id`)
) COMMENT='inscription table';
...
DROP TABLE IF EXISTS `inscription_inventory`;
CREATE TABLE `inscription_inventory` (
                                         `id` bigint NOT NULL AUTO_INCREMENT COMMENT 'Auto-increment id',
                                         `inscription_id` varchar(128) NOT NULL COMMENT 'inscription id',
                                         ...
                                         `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Creation time',
                                         `update_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'update time',
                                         `inscription_tx_qty` int DEFAULT '0' COMMENT 'The number of transactions corresponding to inscription id',
                                         `inscription_owner_tx_qty` int DEFAULT '0' COMMENT 'The number of owner transactions corresponding to the inscription id',
                                         `retry_num` int DEFAULT '0' COMMENT 'Number of retries',
                                         PRIMARY KEY (`id`),
                                         UNIQUE KEY `inscription_id_num` (`inscription_id`,`num`)
) COMMENT='inscription inventory table';

DROP TABLE IF EXISTS `tx_inscription_bak`;
CREATE TABLE `tx_inscription_bak` (
                                      ...
                                      `to` varchar(42) NOT NULL COMMENT 'to address',
                                      `to_type` int DEFAULT NULL COMMENT 'Receiver type',
                                      `value` varchar(255) NOT NULL COMMENT 'Transaction value',
                                      `bn` bigint DEFAULT NULL COMMENT 'block height',
                                      `b_time` datetime DEFAULT NULL COMMENT 'block time',
                                      `tx_fee` varchar(255) DEFAULT NULL COMMENT 'tx fee',
                                      `remark` longtext COMMENT 'note',
                                      `num` bigint DEFAULT NULL COMMENT 'inscription num',
                                      `type` int DEFAULT NULL COMMENT '1-mint;2-transfer',
                                      PRIMARY KEY (`id`)
) COMMENT='inscription transaction backup table';
