...
import com.turn.inscription.bean.StakingBO;
import com.turn.inscription.config.BlockChainConfig;
import com.turn.inscription.dao.custommapper.CustomBubbleMapper;
import com.turn.inscription.dao.custommapper.CustomMicroNodeMapper;
import com.turn.inscription.dao.custommapper.CustomNodeMapper;
...
import com.turn.inscription.dao.entity.NodeExample;
...
import com.turn.inscription.response.home.*;
...
public class HomeService {
    ...
    @Resource
    private CustomMicroNodeMapper customMicroNodeMapper;

    @Resource
    private CustomBubbleMapper customBubbleMapper;
    ...
    public ChainStatisticNewResp chainStatisticNew() {
        ...
        int activeMicroNode = customMicroNodeMapper.selectCountByActive();
        int activeBubble = customBubbleMapper.selectCountByActive();
        chainStatisticNewResp.setActiveBubbles(activeBubble);
        chainStatisticNewResp.setActiveMicroNodes(activeMicroNode);
