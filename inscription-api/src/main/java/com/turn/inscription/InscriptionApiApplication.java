...
@EnableAsync
@MapperScan(basePackages = {"com.turn.inscription.dao.mapper", "com.turn.inscription.dao.custommapper"})
public class InscriptionApiApplication implements ApplicationRunner {
    ...
    public static void main(String[] args) {
        SpringApplication.run(InscriptionApiApplication.class, args);
    }
