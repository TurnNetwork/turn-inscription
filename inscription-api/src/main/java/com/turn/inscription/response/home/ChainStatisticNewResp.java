package com.turn.inscription.response.home;
...
public class ChainStatisticNewResp {
    ...
    // active bubble number
    private Integer activeBubbles;

    // active micro node number
    private Integer activeMicroNodes;

    public Integer getActiveBubbles() {
        return activeBubbles;
    }

    public void setActiveBubbles(Integer activeBubbles) {
        this.activeBubbles = activeBubbles;
    }

    public Integer getActiveMicroNodes() {
        return activeMicroNodes;
    }

    public void setActiveMicroNodes(Integer activeMicroNodes) {
        this.activeMicroNodes = activeMicroNodes;
    }
