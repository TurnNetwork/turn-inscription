package com.turn.inscription.response.proposal;

import com.fasterxml.jackson.databind.annotation.JsonSerialize;
import com.turn.inscription.config.json.CustomRateSerializer;
import com.turn.inscription.config.json.CustomVersionSerializer;
