...
public class Transaction {
    ...
    private List<String> inscriptionContractEventInfo;
    ...
    public enum TypeEnum {
        ...
        /**
         * 13-Inscription contract call (contract execution)
         */
        INSCRIPTION_CONTRACT_EXEC(13, "Inscription contract call (contract execution)"),
        /**
    ...
    public enum ToTypeEnum {
        ...
        ERC1155_CONTRACT(7, "ERC1155-EVM Contract"),GAME_CONTRACT(8, "GAME-EVM Contract"),INSCRIPTION_CONTRACT(9, "INSCRIPTION-EVM Contract");
