...
import com.turn.inscription.bean.ErcToken;
...
import com.turn.inscription.v0152.service.ErcDetectService;
...
public class ErcTokenAnalyzer {
    ...
    public void resolveTx(Block collectionBlock, CollectionTransaction tx, Receipt receipt) {
        try {
            ...
            if (tx.getType() == com.turn.inscription.elasticsearch.dto.Transaction.TypeEnum.CONTRACT_EXEC_DESTROY.getCode()) {
