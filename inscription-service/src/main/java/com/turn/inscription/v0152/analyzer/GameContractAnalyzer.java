...
import com.turn.inscription.bean.GameContract;
import com.turn.inscription.client.TurnClient;
import com.turn.inscription.config.BlockChainConfig;
import com.turn.inscription.contract.GameContract.CreateGameEventResponse;
import com.turn.inscription.dao.entity.*;
import com.turn.inscription.dao.mapper.AddrGameMapper;
import com.turn.inscription.dao.mapper.GameMapper;
import com.turn.inscription.dao.mapper.RoundMapper;
import com.turn.inscription.elasticsearch.dto.ErcTx;
import com.turn.inscription.elasticsearch.dto.GameContractTx;
import com.turn.inscription.enums.GameEventTypeEnum;
import com.turn.inscription.enums.GameTypeEnum;
import com.turn.inscription.enums.RoundStatusEnum;
import com.turn.inscription.service.AddrGameCacheService;
import com.turn.inscription.service.BubbleCacheService;
import com.turn.inscription.utils.CommonUtil;
import com.turn.inscription.v0152.bean.AddrGameDetailDto;
import com.turn.inscription.v0152.bean.BubbleDetailDto;
import com.turn.inscription.v0152.bean.ErcTxInfo;
...
import com.turn.inscription.v0152.service.GameDetectService;
...
public class GameContractAnalyzer {
     ...
     */
    private List<GameContractTx> resolveGameTxFromEvent(Game game, CollectionTransaction tx, List<com.turn.inscription.contract.GameContract.GameTxEvent> eventList, Long seq) {
    ...
    private void endGameHandle(Game game, List<JSONObject> endGameEvents) {
        if(CollUtil.isNotEmpty(endGameEvents)){
            List<Long> roundIds = endGameEvents.stream().map(x -> {
                com.turn.inscription.contract.GameContract.EndGameEventResponse item = JSONObject.toJavaObject(x, com.turn.inscription.contract.GameContract.EndGameEventResponse.class);
    ...
    private void joinGameHandle(Game game, List<JSONObject> joinGameEventResponses) {
        if(CollUtil.isNotEmpty(joinGameEventResponses)){
            ...
            joinGameEventResponses.forEach(x->{
                com.turn.inscription.contract.GameContract.JoinGameEventResponse item = JSONObject.toJavaObject(x, com.turn.inscription.contract.GameContract.JoinGameEventResponse.class);
